...
графа доказанных семантических отношений и инструментов
...
Голосовые владельца распознаются через отдельный OpenAI Transcriptions API.
Приватное аудио, исходный update и производная расшифровка связаны хешем;
неопределённый результат платного запроса блокирует автоматический повтор.
Ключ лежит отдельно от настроек и не передаётся модели или sandbox.
Контракт, ограничения и расход описаны в [VOICE.md](VOICE.md).
