...
### Ключевые принципы:
1. **Использовать gpt-4.1-mini** (быстрее и стабильнее в наших тестах)
...
mark_agent = Agent(
    name="Mark",
    model="gpt-4.1-mini",  # Используем модель из .env!
    instructions="""
...
3. **gpt-4.1-mini** для всех вызовов - экономия и консистентность
