...
class AnalysisEngine:
    ...
    def analyze_codebase(self, project_path: Optional[str] = None) -> Dict[str, Any]:
        """
    ...
    def analyze_sandbox_experiments(self, experiment_filename: Optional[str] = None) -> Dict[str, Any]:
        """
    ...
    def _extract_keywords(self, text: str) -> List[str]:
        ...
        stop_words = {'и', 'в', 'на', 'с', 'по', 'для', 'от', 'до', 'из', 'к', 'у', 'о', 'об', 'за', 'при', 'под', 'над', 'между', 'через', 'без', 'про', 'это', 'то', 'так', 'как', 'что', 'где', 'когда', 'почему', 'какой', 'какая', 'какое', 'какие', 'мой', 'моя', 'мое', 'мои', 'твой', 'твоя', 'твое', 'твои', 'наш', 'наша', 'наше', 'наши', 'ваш', 'ваша', 'ваше', 'ваши', 'его', 'ее', 'их', 'себя', 'тот', 'та', 'то', 'те', 'этот', 'эта', 'это', 'эти', 'такой', 'такая', 'такое', 'такие', 'столько', 'столь', 'сколько', 'сколь', 'который', 'которая', 'которое', 'которые', 'чей', 'чья', 'чье', 'чьи', 'сам', 'сама', 'само', 'сами', 'самый', 'самая', 'самое', 'самые', 'весь', 'вся', 'все', 'все', 'каждый', 'каждая', 'каждое', 'каждые', 'любой', 'любая', 'любое', 'любые', 'никто', 'ничто', 'никакой', 'никакая', 'никакое', 'никакие', 'ничей', 'ничья', 'ничье', 'ничьи', 'некто', 'нечто', 'некий', 'некая', 'некое', 'некие', 'чей-то', 'чья-то', 'чье-то', 'чьи-то', 'кто-то', 'что-то', 'какой-то', 'какая-то', 'какое-то', 'какие-то', 'кто-либо', 'что-либо', 'какой-либо', 'какая-либо', 'какое-либо', 'какие-либо', 'кто-нибудь', 'что-нибудь', 'какой-нибудь', 'какая-нибудь', 'какое-нибудь', 'какие-нибудь', 'я', 'ты', 'он', 'она', 'оно', 'мы', 'вы', 'они', 'я', 'меня', 'мне', 'мной', 'мною', 'ты', 'тебя', 'тебе', 'тобой', 'тобою', 'он', 'его', 'ему', 'им', 'ним', 'она', 'ее', 'ей', 'ею', 'ней', 'оно', 'его', 'ему', 'им', 'ним', 'мы', 'нас', 'нам', 'нами', 'вы', 'вас', 'вам', 'вами', 'они', 'их', 'им', 'ими', 'ними', 'себя', 'себе', 'собой', 'собою', 'мой', 'моя', 'мое', 'мои', 'моих', 'моим', 'моими', 'твой', 'твоя', 'твое', 'твои', 'твоих', 'твоим', 'твоими', 'свой', 'своя', 'свое', 'свои', 'своих', 'своим', 'своими', 'наш', 'наша', 'наше', 'наши', 'наших', 'нашим', 'нашими', 'ваш', 'ваша', 'ваше', 'ваши', 'ваших', 'вашим', 'вашими', 'его', 'ее', 'их', 'тот', 'та', 'то', 'те', 'тех', 'тем', 'теми', 'этот', 'эта', 'это', 'эти', 'этих', 'этим', 'этими', 'такой', 'такая', 'такое', 'такие', 'таких', 'таким', 'такими', 'столько', 'столь', 'сколько', 'сколь', 'который', 'которая', 'которое', 'которые', 'которых', 'которым', 'которыми', 'чей', 'чья', 'чье', 'чьи', 'чьих', 'чьим', 'чьими', 'сам', 'сама', 'само', 'сами', 'самих', 'самим', 'самими', 'самый', 'самая', 'самое', 'самые', 'самых', 'самым', 'самыми', 'весь', 'вся', 'все', 'всех', 'всем', 'всеми', 'каждый', 'каждая', 'каждое', 'каждые', 'каждых', 'каждым', 'каждыми', 'любой', 'любая', 'любое', 'любые', 'любых', 'любым', 'любыми', 'никто', 'ничто', 'никакой', 'никакая', 'никакое', 'никакие', 'никаких', 'никаким', 'никакими', 'ничей', 'ничья', 'ничье', 'ничьи', 'ничьих', 'ничьим', 'ничьими', 'некто', 'нечто', 'некий', 'некая', 'некое', 'некие', 'неких', 'неким', 'некими', 'чей-то', 'чья-то', 'чье-то', 'чьи-то', 'чьих-то', 'чьим-то', 'чьими-то', 'кто-то', 'что-то', 'какой-то', 'какая-то', 'какое-то', 'какие-то', 'каких-то', 'каким-то', 'какими-то', 'кто-либо', 'что-либо', 'какой-либо', 'какая-либо', 'какое-либо', 'какие-либо', 'каких-либо', 'каким-либо', 'какими-либо', 'кто-нибудь', 'что-нибудь', 'какой-нибудь', 'какая-нибудь', 'какое-нибудь', 'какие-нибудь', 'каких-нибудь', 'каким-нибудь'}
