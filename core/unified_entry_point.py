...
class UnifiedEntryPoint:
    ...
    def process_message(self, message: str, chat_id: int, user_id: Optional[int] = None) -> Dict[str, Any]:
        """
    ...
    async def process_message_async(self, message: str, chat_id: int, user_id: Optional[int] = None) -> Dict[str, Any]:
        """
