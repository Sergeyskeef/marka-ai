...
class BackendSelector:
    ...
    def get_memory_class(self,
        ...
        try:
            ...
            if selected_backend == MemoryBackend.GRAPHITI:
                ...
                if self._is_graphiti_available():
                    logger.debug("🤖 AUTO: GraphitiMemory доступен, используем его")
                    return GraphitiMemoryAdapter
                else:
                    logger.debug("🤖 AUTO: GraphitiMemory недоступен, fallback на GraphitiMemory")
                    return GraphitiMemoryAdapter
    ...
    def create_memory_instance(self,
                             ...
                             backend: str | None = None,
                             session_id: str | None = None,
                             **kwargs) -> "GraphitiMemoryAdapter | MultiLayerMemory":
        """
...
def get_memory_class(backend: str | None = None,
                    session_id: str | None = None) -> type:
