...
class EnhancedMemory(BaseMemory):
    ...
    def add_insight(self, insight_type: InsightType, content: str, metadata: dict | None = None) -> str:
    ...
    def get_insights(self, insight_type: InsightType | None = None) -> list[dict]:
        """Получение инсайтов.
    ...
    def analyze_historical_data(self, category: str, time_period: timedelta | None = None) -> dict:
    ...
    def get_historical_summary(self, categories: list[str] | None = None) -> dict:
    ...
    def _get_last_update(self, data: dict[str, dict]) -> datetime | None:
