...
from langchain_api.rag.enhanced_rag_chain import generate_enhanced_response, SYSTEM_PROMPT_BASE
...
def test_capabilities_command():
    ...
    try:
        ...
        from langchain_api.telegram_bot.bot import capabilities_cmd
        ...
        for cmd in COMMANDS_REGISTRY:
            if cmd["name"] == "/capabilities":
                ...
                print(f"✅ Команда /capabilities найдена в реестре")
